...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute -bottom-[1.5rem] left-10 right-10 h-0.25 bg-n-6 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute -bottom-[1.8125rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute -bottom-[1.8125rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
